...
import info.u_team.extreme_cobble_generator.block.BlockCobbleGenerator;
...
public class ExtremeCobbleGeneratorBlocks {
	...
	public static final UBlock cobblegenerator = new BlockCobbleGenerator("cobblegenerator");
